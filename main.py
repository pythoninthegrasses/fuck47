...
def main():
    ...
    if DJT_FILTER_ENABLED:
        ...
        # If the judge call fails, skip rewriting filtered_articles.json so the
        ...
        if djt_articles and SENTIMENT_ENABLED:
            try:
                ...
                print(f"Sentiment analysis failed ({e}); keeping existing filtered_articles.json unchanged")
        ...
        if negative_articles is not None:
            ...
            print(f"Stored {len(negative_articles)} articles in filtered_articles.json")
