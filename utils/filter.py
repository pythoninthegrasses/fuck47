...
DJT_KEYWORDS = {
    ...
    'primary': {
        'trump', 'donald', 'maga', 'presidency', 'president', 'administration',
        'white house', 'republican', 'gop', 'election', 'campaign', 'rally',
        'rallies', 'impeachment', 'january 6', 'mar-a-lago', 'truth social'
    },
    
    # Secondary keywords (moderate relevance)
    'secondary': {
        'biden', 'harris', 'pence', 'desantis', 'musk', 'endorsement',
        'endorsements', 'primary', 'primaries', 'convention', 'debate',
        'debates', 'transition', 'appointment', 'appointments', 'nominee',
        'candidates', 'nomination'
    },
    
    # Policy keywords (contextual relevance)
    'policy': {
        'immigration', 'border', 'wall', 'mexico', 'china', 'trade', 'tariffs',
        'supreme court', 'judges', 'foreign policy', 'iran', 'israel',
        'covid-19', 'pandemic', 'tax', 'taxes', 'classified documents',
        'indictment', 'investigation', 'fraud', 'conviction', 'lawsuit',
        'legal', 'georgia', 'new york', 'florida'
    }
}
